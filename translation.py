...
ᴛʜɪs ʙᴏᴛ ɪs ᴘᴏᴡᴇʀᴇᴅ ʙʏ <a href="@onefighterarmy">ᴛᴇᴄʜ ᴠᴊ</a></b>
"""

    TECH_VJ_HELP_TEXT = """
<b>🖍️ ғᴇᴀᴛᴜʀᴇs :-

🔺 ᴜᴘʟᴏᴀᴅ <a href="@onefighterarmy">ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ ʟɪɴᴋs</a> ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ.
...
🔻 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs <a href="https://t.me/sujay8371">ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ</a>
...
🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/sujay8371">ᴠᴊ ʙᴏᴛᴢ</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="@onefighterarmy">ᴛᴇᴄʜ ᴠᴊ</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('💝 JOIN MY TELEGRAM CHANNEL', url='https://t.me/sujay8371')
        ], [
            ...
            InlineKeyboardButton('🇮🇳 ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ 💖', url='https://www.instagram.com/hii_fyi?igsh=MWhzYW84Mng0dXdvYg==')
        ]]
    )
    
    TECH_VJ_ABOUT_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='gh')
        ], [
